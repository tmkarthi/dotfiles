...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tmkarthi/dotfiles/tmkarthi/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tmkarthi/dotfiles/tmkarthi/install.sh`" -s ask
```
